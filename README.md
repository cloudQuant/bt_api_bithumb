...
This package provides **Bithumb exchange plugin for bt_api** for the [bt_api](https://github.com/cloudQuant/bt_api_py) framework. It offers a unified interface for interacting with **BITHUMB** exchange.
...
| GitHub Repository | https://github.com/cloudQuant/bt_api_bithumb |
| Issue Tracker | https://github.com/cloudQuant/bt_api_bithumb/issues |
...
```
bt_api_bithumb/
├── src/bt_api_bithumb/     # Source code
...
- Report bugs via [GitHub Issues](https://github.com/cloudQuant/bt_api_bithumb/issues)
...
本包为 [bt_api](https://github.com/cloudQuant/bt_api_py) 框架提供 **Bithumb exchange plugin for bt_api**。它提供了与 **BITHUMB** 交易所交互的统一接口。
...
| GitHub 仓库 | https://github.com/cloudQuant/bt_api_bithumb |
...
- 通过 [GitHub Issues](https://github.com/cloudQuant/bt_api_bithumb/issues) 反馈问题
